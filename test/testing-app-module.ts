...
/**
 * Use this in integration/e2e tests instead of importing raw {@link AppModule} (which has no
 * `imports` until `forRoot` runs) or calling `AppModule.forRoot()` without thinking about env.
 *
